        ...
        <main className="min-h-screen pt-32 pb-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col items-center text-center space-y-8 mb-32">
                    <span className="text-sm font-black uppercase tracking-[0.5em] text-pink-500">Mastery in Every Stitch</span>
                    <h1 className="text-6xl md:text-8xl font-black text-gray-900 tracking-tighter italic uppercase leading-tight">
                        Our <br />
                ...
                <div className="space-y-48">
                    {[
                        ...
                        <div key={idx} className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                            <div className="relative aspect-square overflow-hidden rounded-[64px] group">
                            ...
                            <div className="space-y-8">
                                <div className="space-y-2">
                                    <p className="text-xs font-black uppercase tracking-[0.4em] text-pink-500">{story.location}</p>
                                    <h2 className="text-5xl font-black text-gray-900 tracking-tighter italic uppercase">{story.name}</h2>
                                </div>
                                <p className="text-xl text-gray-600 leading-relaxed font-medium italic">"{story.desc}"</p>
                        ...
                        <div key={idx} className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                            ...
                            <div className="relative aspect-square overflow-hidden rounded-[64px] group order-1 lg:order-2">
                                <Image src={story.image} alt={story.name} fill className="object-cover transition-transform duration-[3s] group-hover:scale-110" />
                            </div>
                        </div>
                    )))}
                ...
                {/* Craftsmanship Stats */}
                <div className="mt-48 grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-gray-100 pt-24">
                    {[
                        ...
                        <div key={stat.label} className="text-center space-y-2">
                            <p className="text-5xl font-black text-gray-900 tracking-tighter uppercase">{stat.value}</p>
